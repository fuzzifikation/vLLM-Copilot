...
| Patch-mode `undefined` spread hazard | §4.2 step 3c | Strip `undefined` update keys (hardening) — *done 3c*; replace-path counterpart (never persist `undefined`, merge + append) — *done 3d* |
