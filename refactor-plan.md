...
|---|---|---|
| Unify divergent `saveModelConfig` | §4.2 steps 3a–3b | Named `replaceModelConfig` / `patchModelConfig` operations — *3a done (replace); webview patch pending 3b* |
