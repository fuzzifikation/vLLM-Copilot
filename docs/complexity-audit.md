...
- Open for unit 3, ruled by owner 2026-09-26: P C-1 (janitor UI out of `commands.ts` into `commands/cleanSessions.ts`, lying header rewritten), P C-2 (diagnose/log/dashboard-web registrations to their domain files, precedent R7-P5-1/2, bundled with P C-1 so no trivia unit exists alone).
